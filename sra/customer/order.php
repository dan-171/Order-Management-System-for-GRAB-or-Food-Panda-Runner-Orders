...
//grp diff types of mee kuah/ng/mg by name
...
//addr for next page of each table
$nextPage = [
  "Signature"     => "orderExtras",
  "Breakfast"     => "orderExtras",
  "Lunch"         => "review",
  "Roti"          => "review",
  "Ikan"          => "review",
  "Ala-Carte"     => "orderExtras",
  "Ala-Carte 2"   => "orderExtras",
  "Western"       => "orderExtras",
...
// prt "Sold Out" for unavailable items
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (isset($_POST['submit_step1']) || isset($_POST['submit_step2']))) {
  ...
  if ($nextPage[$category] === "orderExtras")
    header("Location: " . $nextPage[$category] . ".php?category=" . $category);
  else
    header("Location: " . $nextPage[$category] . ".php");
}
